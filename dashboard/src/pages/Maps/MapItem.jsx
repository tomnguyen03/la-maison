      ...
      <div>
        ...
        <div className="py-5">
          ...
          <div className="mt-4 flex justify-around px-5 border-b-2 border-grey-d9 pb-4">
            <div
              className="flex flex-col justify-center items-center text-sm text-red-500 cursor-pointer"
              onClick={() =>
                handleClickDirection({
                  latitude: lat,
                  longitude: lng
            ...
            {!isMobile ? (
              <Link
                to={`/${id}`}
                target="_blank"
                className="flex flex-col justify-center items-center text-sm text-red-500 cursor-pointer font-prata"
              >
                <i className="bx bxs-right-arrow-circle text-3xl"></i>
                Xem chi tiết
              </Link>
